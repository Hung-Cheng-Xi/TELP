...
目前專案聚焦在「快速開始一輪複習」：選擇章節、設定題數與是否隨機出題後，可以進入翻卡式單字卡、中英文配對、選擇題或單字輸入練習。整體介面支援桌機與手機瀏覽，也具備 PWA 安裝與離線快取能力。
...
| `第六章-Accelerometer & Gyroscope.json` | 75 |
| `第七章-Knowledge Management.json` | 40 |
| `第八章-What are Trademarks.json` | 45 |
| `第九章-What is Copyright.json` | 49 |
